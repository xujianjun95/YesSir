...
function ensureYsThemeStylesInjected() {
    ...
    style.textContent = `
        :root {
          --ys-overlay-bg: rgba(160, 175, 200, 0.20);
          --ys-card-bg: rgba(250, 252, 255, 0.72);
          ...
          --ys-search-bg: rgba(255, 255, 255, 0.64);
          ...
          --ys-search-focus-bg: rgba(255, 255, 255, 0.82);
          ...
          --ys-settings-bg: rgba(255, 255, 255, 0.88);
